...
Seguirà quindi una descrizione approfondita della scelta di certe tecnologie ma soprattutto del perché le si è scelte. Il capitolo 3
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Complete graph:} i links vengono in modo tale che ogni nodo sia collegato a tutti i nodi rimanenti. Non c'è un riferimento esplicito al posizionamento poiché, come vedremo successivamente, sarà compito del visualizzatore grafico disporre i nodi nello spazio.
