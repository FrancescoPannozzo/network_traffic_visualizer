...
Partendo dal grafo completo, come descritto precedentemente, un grafo completo può essere disposto in modo automatico e imposto tramite coordinate dei nodi dall'utente. 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{immagini/custom_complete_autopositioning.JPG}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{immagini/custom_complete_manual_positioning.JPG}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{immagini/mesh_not_full.JPG}
...
in base all'ID con il quale vengono rappresentati, possiamo vedere un esempio in figura \ref{adaptive_dots_example}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{immagini/adaptive_dots_example.JPG}
    \caption{visualizzazione grafo mesh con opzione dotsSize posta ad adaptive}
    \label{adaptive_dots_example}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{immagini/torus_full_24.JPG}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{immagini/torus_not_full_adaptive.JPG}
    \caption{grafo torus non completo}
    \label{torus_not_full_adaptive}
\end{figure}

Osservando gli esempi del torus graph si può notare come i link dei nodi delle estremità sia meno spesso degli altri che formano la griglia.
...
le varie tipologie di dati (fig. \ref{switch_info} e fig. \ref{links_info})

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{immagini/switch_info.JPG}
    \caption{un frammento di video sulle info degli switch}
    \label{switch_info}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{immagini/links_info.JPG}
    \caption{un frammento di video sulle info dei links}
    \label{links_info}
\end{figure}
