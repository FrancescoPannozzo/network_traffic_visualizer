...
\section{Avvio del generatore e files prodotti}
...
\[ l = \frac{n(n-1)}{2} \]
Si parla quindi di una crescita esponenziale al variare del numero di nodi.
Per grafo mesh si è inteso una rappresentazione in cui ogni nodo ha quattro nodi adiacenti, fatta eccezione dei nodi che risiedono alle estremità, come
raffigurato nell'esempio in figura \ref{fig:mesh_example}.
