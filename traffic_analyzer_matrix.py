...
# frontend file input
logging.info("Writing analyzed_data_matrix.yaml file..")
try:
    with open('./data/analyzed_data_matrix.yaml', 'w', encoding="utf-8") as file:
...
logging.info("analyzed_data_matrix.yaml file creation done!")
